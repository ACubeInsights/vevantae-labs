      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-card rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              <div className="w-3 h-3 bg-green-500 rounded-full mr-3"></div>
              <span>
                ✅ <strong>Complete session duration tracking</strong>
              </span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-green-500 rounded-full mr-3"></div>
              <span>
                ✅ <strong>Session milestones (30s, 1m, 2m, 5m, 10m)</strong>
              </span>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-blue-700 text-sm">
              You should see a live session tracking dashboard showing your current session
              duration, page views, and interactions in real-time.
            </p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-lg shadow-md p-8 mb-8">
          ...
          <p className="text-gray-600 mb-6">
            Click these buttons to test different types of event tracking. Check your browser&apos;s
            Network tab or Google Analytics Real-time reports to see the events.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              onClick={handleTestEvent}
              className="px-6 py-3 bg-blue-600 text-primary-foreground rounded-lg hover:bg-blue-700 transition-colors"
            >
              Test Custom Event
            </button>
            ...
            <button
              ...
              className="px-6 py-3 bg-green-600 text-primary-foreground rounded-lg hover:bg-green-700 transition-colors"
            >
              Test Product View
            </button>
            ...
            <button
              ...
              className="px-6 py-3 bg-purple-600 text-primary-foreground rounded-lg hover:bg-purple-700 transition-colors"
            >
              Test Form Submit
            </button>
          </div>
        ...
        <div className="bg-card rounded-lg shadow-md p-8">
          ...
          <div className="space-y-3 text-gray-700">
            ...
            <div className="pl-4">
              ...
              <code className="bg-muted px-2 py-1 rounded">G-VDMQ3FND7S</code>
            </div>

            <div className="font-medium mt-4">Step 2: Check Real-time Data</div>
            <div className="pl-4">
              → Navigate to <strong>Reports → Realtime</strong>
            </div>
            ...
            <div className="pl-4">
              → Look for: <code className="bg-muted px-1 rounded">test_button_click</code>,{' '}
              <code className="bg-muted px-1 rounded">view_item</code>,{' '}
              <code className="bg-muted px-1 rounded">form_submit</code>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-8">
          <Link
            href="/"
            className="inline-block px-6 py-3 bg-gray-800 text-primary-foreground rounded-lg hover:bg-gray-900 transition-colors"
          >
            ← Back to Home
          </Link>
        </div>
