      ...
      <main>
                  ...
                  {isSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        ...
                        className="w-full bg-primary text-primary-foreground py-4 px-6 rounded-lg hover:bg-neutral-strong transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                      >
                        {isSubmitting ? (
                          <>
        ...
        <section className="bg-card py-20">
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-4xl font-light text-foreground mb-6">B2B Partnership FAQs</h2>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-4xl font-light text-foreground mb-6">Manufacturing Facility</h2>
              <p className="text-lg text-secondary max-w-2xl mx-auto">
                Visit our state-of-the-art manufacturing and R&D facility to see our quality
                processes and discuss partnership opportunities.
              </p>
            </motion.div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-lg text-secondary">Interactive Map Coming Soon</p>
