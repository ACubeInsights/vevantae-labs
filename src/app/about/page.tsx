      ...
      <main>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-light text-foreground mb-4">Our Values</h2>
        ...
        <section className="py-20 bg-card">
          <div className="container mx-auto px-6">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h2 className="text-3xl lg:text-4xl font-light text-foreground mb-4">Our Journey</h2>
              <p className="text-lg text-secondary max-w-2xl mx-auto">
                ...
                {timeline.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      <h3 className="text-2xl font-light text-foreground">{item.year}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {team.map((member, index) => (
                <motion.div
                  ...
                  className="text-center space-y-4"
                >
                  <div className="relative aspect-square bg-muted rounded-sm overflow-hidden mx-auto max-w-xs">
                    <Image
                      src={member.image}
                      alt={member.name}
                      fill
