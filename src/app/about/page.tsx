...
const values = [
  {
    ...
    description: 'We believe in treating the whole person, not just symptoms, through comprehensive wellness solutions.'
  },
  {
    icon: Users,
    title: 'Community First',
    description: 'Our customers are at the heart of everything we do, and we build lasting relationships based on trust.'
  },
  {
    icon: Target,
    title: 'Quality Excellence',
    description: 'We maintain the highest standards in sourcing, manufacturing, and testing of all our products.'
  },
  {
    icon: Eye,
    title: 'Transparency',
...
const timeline = [
  {
    year: '2018',
    title: 'Foundation',
    description: 'Vevantae Labs was founded with a vision to bridge ancient wisdom and modern science.'
  },
  {
    year: '2019',
    title: 'First Products',
    description: 'Launched our first line of premium ayurvedic formulations after extensive research.'
  },
  {
    year: '2020',
    title: 'Expansion',
    description: 'Expanded into nutraceuticals and established partnerships with leading research institutions.'
  },
  {
    year: '2021',
    title: 'Recognition',
  ...
  },
  {
    year: '2022',
    title: 'Global Reach',
    description: 'Expanded our reach to serve customers worldwide while maintaining quality standards.'
  },
  {
    year: '2023',
    title: 'Innovation',
    description: 'Launched advanced formulations combining cutting-edge research with traditional knowledge.'
  }
]
        ...
        <section className="py-20 lg:py-32">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              >
                Bridging ancient wisdom with modern science to create transformative 
                wellness solutions that honor tradition while embracing innovation.
              </motion.p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              >
                ...
                <p className="text-lg text-[#666666] leading-relaxed">
                  ...
                  combining the best of traditional knowledge with modern scientific validation 
                  to support holistic health and well-being.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-lg text-[#666666] leading-relaxed">
                  To be the global leader in integrative wellness solutions, creating a world 
                  where traditional wisdom and modern science work together to enhance human 
                  health and promote sustainable well-being.
                </p>
              </motion.div>
            </div>
          </div>
