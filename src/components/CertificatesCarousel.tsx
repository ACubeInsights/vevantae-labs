...
const certificates: Certificate[] = [
  {
    ...
    description:
      'ISO 9001:2015 - Our products meet international quality management system standards.',
  },
  {
    id: 'ayush',
    ...
    description:
      'AYUSH Approved - All traditional formulations are certified by Ministry of AYUSH, India.',
  },
  {
    id: 'cruelty-free',
        ...
        <AnimatePresence>
          {hoveredCert && (
            <motion.p
              ...
              className="text-base lg:text-lg text-secondary italic text-center max-w-4xl px-6 leading-relaxed"
            >
