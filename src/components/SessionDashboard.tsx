...
export function SessionDashboard() {
    ...
    const updateSessionData = () => {
      ...
      setSessionData({
        ...
        startTime: sessionStartTime
          ? new Date(parseInt(sessionStartTime)).toLocaleTimeString()
          : '',
      });
    };
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-card border-2 border-border rounded-lg shadow-lg p-4 max-w-sm z-50">
      <div className="text-sm font-semibold text-gray-800 mb-2">🔍 Live Session Tracking</div>
      ...
      <div className="space-y-2 text-xs">
        ...
        <div className="flex justify-between pt-2 border-t border-border">
          ...
          <span
            className={`font-bold ${getQualityColor(sessionData.duration, sessionData.interactions, sessionData.pages)}`}
          >
